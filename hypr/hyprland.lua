...
require("conf.input.cursor")
require("conf.input.keyboard")
require("conf.input.monitor")
...
hl.bind(mainMod .. " + ALT + SHIFT + S", hl.dsp.exec_cmd(programs.screenshot))
...
-- hl.bind(mainMod .. " + N", hl.dsp.workspace.move)
